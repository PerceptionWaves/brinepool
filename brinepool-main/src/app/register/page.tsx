        ...
        <form onSubmit={handleRegister} className="space-y-5">
          ...
          <div>
            ...
            <input
              type="email"
              required
              pattern="^[A-Za-z0-9._%+\-]+@[A-Za-z0-9.\-]+\.(edu|edu\.[a-z]{2,3}|ac\.[a-z]{2,3})$"
              title="Must be an academic email (.edu, .edu.<cc>, or .ac.<cc>)"
              value={ownerEmail}
            ...
            <p className="mt-1 text-xs text-muted">
              Currently limited to .edu, .edu.&lt;cc&gt; (e.g. .edu.sg), and
              .ac.&lt;cc&gt; (e.g. .ac.uk) domains.
            </p>
          </div>
          <div>
            <label className="block text-sm font-medium mb-1">
